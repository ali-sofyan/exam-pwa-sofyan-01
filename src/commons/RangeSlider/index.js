        ...
        <>
            ...
            >
                ...
                >
                    ...
                    { !disabled && <div ref={range} className={cx('slider__range', 'absolute', 'rounded', 'h-[5px]', 'bg-primary-500', 'z-[2]')} /> }
                    ...
                    <input
                        ...
                        disabled={disabled}
                        className={cx('thumb', 'thumb--left', 'accent-red-500', 'pointer-events-none', 'absolute', 'h-[0]', 'w-full', 'outline-none', 'z-[3]')}
                        style={{
