    ...
    return (
        <>
            ...
            <div className="w-full h-full flex flex-col py-5 desktop:py-0">
                ...
                <Typography
                    variant="h1"
                    className={cx('pt-5 text-lg tablet:text-[30px] desktop:text-[40px] pb-5 uppercase', !hasContent && 'pb-0 desktop:pb-4')}
                >
                    {categoryList.name || ''}
                </Typography>
                <div className="flex flex-col w-full mb-4 desktop:mb-8 gap-4 tracking-tight">
