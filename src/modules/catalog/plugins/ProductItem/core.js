            ...
            <div className="flex flex-col gap-2 tablet:gap-4">
                ...
                <div className="hidden tablet:flex desktop:flex flex-row gap-1 justify-center items-center w-full">
                    ...
                    <Show when={showWishlist || showProductCompare}>
                        <div className="flex-row gap-1 hidden tablet:flex desktop:flex opacity-0 group-hover/productitem:opacity-100 absolute bottom-full justify-center left-0 right-0">
            ...
            <>
                ...
                <div
                    className={classNames(
                        ...
                        'flex flex-col swift-catalog-item-product group/productitem',
                        className,
                    )}
                >
                    ...
                    <div className="pt-4 relative flex flex-col gap-4 flex-1">
                        ...
                        <Show when={showOption}>
                            <div className={`hidden tablet:flex desktop:flex flex-col gap-2 tablet:gap-4 h-full justify-between configurable-swatches ${isOos ? 'disable-options' : ''}`}>
                                <ConfigurableOpt
                                    t={t}
                                    data={{
                                        ...other,
            ...
            >
                ...
                <div className="basis-full h-full">
                    <div className="flex flex-col gap-4 start-xs h-full justify-between">
                        ...
                        />
                        {showOption ? (
                            <div className={classNames('hidden tablet:flex flex-col justify-between h-full gap-2 lg:gap-4 configurable-swatches')}>
                                <ConfigurableOpt
                                    t={t}
                                    data={{
                                        ...other,
