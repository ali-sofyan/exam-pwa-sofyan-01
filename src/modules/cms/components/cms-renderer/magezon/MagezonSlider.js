        ...
        <>
                ...
                {owl_nav ? (
                    <div
                        className={cx('flex', 'justify-between', 'pointer-events-none', {
                            ...
                            'opacity-0 md:opacity-100 absolute w-full top-[50%] -translate-y-[50%] z-[2]':
                    ...
                    >
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 hover:text-primary text-white" />
                        </div>
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item',
                        ...
                        >
                            <ChevronRight className="w-6 h-6 hover:text-primary text-white" />
                        </div>
                    </div>
                ) : null}
            ...
            <style jsx>
                {`
                    ...
                    .magezon-slider--button-nav-item {
                        position: relative;
                        background-color: ${owl_background_color || 'rgba(18, 18, 18, 0.40)'};
                        width: ${navSize * 2}px;
                        height: ${navSize * 2}px;
                        display: flex;
                        align-items: center;
